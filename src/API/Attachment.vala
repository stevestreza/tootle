public class Tootle.API.Attachment : Entity, Widgetizable {
	...
	private string? preview_url_field { get; set; }
	public string? preview_url {
		set { this.preview_url_field = value; }
		get { return (this.preview_url_field == null || this.preview_url_field == "") ? url : preview_url_field; }
	}
